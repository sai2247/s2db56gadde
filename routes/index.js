...
router.get('/', function (req, res) { 
    res.render('index', { title: 'dollargeneral App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'dollargeneral App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'dollargeneral App Login', user : req.user }); 
}); 
